...
class VisitActionRepository {
  ...
  Future<void> submit({required String type, required String endpoint, required String outletId, required String visitId, required String reason, String? followUpAt}) async {
    ...
    final record = {'id': id, 'visitId': visitId, 'outletId': outletId, 'type': type, 'reason': reason, 'followUpAt': followUpAt, 'location': location?.toJson(), 'status': 'pending_sync', 'createdAt': DateTime.now().toIso8601String()};
